...
color_scheme <- c("#fdae61", "#abd9e9", "#d7191c", "#2c7bb6")
...
```{r create dendrogram, message=FALSE, warning=FALSE, comment = FALSE}
...
## s2t the cutoff
MEDissThres <- 0 # using 0.XX as of 12 July 2022 # in the first pass, set this to 0 - no merging (we want to see the module-traits heatmap first, then decide which modules are telling us the same story and better be merged)

...
mean_se_plot <- ggplot(plasticity_means_se, aes(x=treat, y=mean_N, colour = treat)) + 
  ...
  geom_point(data = ge_plast_2, x = ge_plast_2$treat, y = ge_plast_2$dist, color = "black")
...
mean_se_plot_all <- ggplot(plasticity1_means_se, aes(x=treat, y=mean_N, colour = treat)) + 
  ...
  ggtitle("D)") +
  theme(legend.position = "none") +
  geom_point(data = ge_plast_all, x = ge_plast_all$treat, y = ge_plast_all$dist, color = "black")

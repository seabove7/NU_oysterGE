...
# treatment DEGs
col= colorRampPalette(rev(c('#d01c8b', 'white', '#4dac26')),bias=0.8)(30)
pheatmapfig <- pheatmap(heat_df, color = col, cluster_cols = TRUE, clustering_distance_rows = "correlation", show_colnames = FALSE, show_rownames = TRUE, annotation_col = df1, annotation_colors = ann_colors, fontsize = 30)  
pheatmapfig

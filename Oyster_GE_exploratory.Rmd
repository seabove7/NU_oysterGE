...
DEG_bar <- data.frame("treat" = c("400 pCO2; sponge v none", "No sponge; pCO2 comparison", "Control v double trt", "Sponge; pCO2 comparison", "pCO2: sponge v none", "High pCO2: sponge v none"), 
...
venn_trt_df <- list("up" = downTrt_S, "up" = upTrt_S)

## Comparing up NS_400 vs S_400 and up NS_400 vs NS_2800
venn_loci_df <- list("up NS_400 vs S_400" = upCon_S, "up NS_400 vs NS_2800" = upTrt_N)

## Comparing up NS_400 vs S_2800 and up S_2800 vs NS_2800
venn_loci_df <- list("up NS_400 vs S_2800" = upTrt_S, "up S_2800 vs NS_2800" = upsshn)

## Comparing up NS_400 vs S_2800 and up S_2800 vs NS_2800
venn_loci_up <- list("up NS_400 vs S_2800" = upTrt_S, "down S_2800 vs NS_2800" = uptrtS)

## Comparing down NS_400 vs S_2800 and up S_2800 vs NS_2800
venn_loci_down <- list("down NS_400 vs S_2800" = downTrt_S, "down S_2800 vs NS_2800" = downsshn)

## Comparing down NS_400 vs S_2800 and down S_2800 vs S_400
venn_loci2_down <- list("down NS_400 vs S_2800" = downTrt_S, "down S_2800 vs NS_2800" = downtrtS)

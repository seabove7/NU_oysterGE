...
pheatmapfig <- pheatmap(heat_df, color = col, cluster_cols = TRUE, clustering_distance_rows = "correlation", show_colnames = TRUE, show_rownames = TRUE, annotation_col = df1, annotation_colors = ann_colors, fontsize = 30)  
pheatmapfig

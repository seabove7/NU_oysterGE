...
my $div=shift;
my $path=shift;
my $path2=shift or die "$usage\nNot enough arguments for gomwu_b.pl\n";

my $clfile=$path."cl_dissim0_".$div."_".$gen2go; 
...
my $inname3=$path2.$div."_".$measure;
my $inname5=$path.$inname4;
	...
	open OUT, ">$inname5" or die "gomwu_b: cannot create output $inname4\n";
	print {OUT} join("\t",@gos),"\n";

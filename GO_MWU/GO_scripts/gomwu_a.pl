...
my $gen2goP=$path.$gen2go;
my $inname2=$path2.$measure.".".$div.".tmp";
my $inname3=$div."_".$measure;
my $inname31=$path."dissim0_".$div."_".$gen2go;
my $inname4=$path."dissim_".$div."_".$gen2go;

my @donealready=();

open GO, $onto or die "cannot open ontology $onto\n";
open CORAL, $gen2goP or die "cannot open genes2go table $gen2go\n";
open DNDS, $path2.$measure or die "cannot open measure table $measure\n";
my $outname=$inname2;
